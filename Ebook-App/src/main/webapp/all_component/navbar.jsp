...
<div class="countainer_fluid p-3 bg-light">
	<div class="row">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="all_recent_book.jsp"><i
					class="fas fa-book-open"></i> Recent</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<a href="helpline.jsp" class="btn btn-light my-2 my-sm-0 ml-1" type="submit"><i class="fas fa-phone-square-alt"></i> Contact
				Us</a>
		</form>
	</div>
</nav>